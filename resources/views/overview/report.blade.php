      ...
      <div class="col-lg-12">
        <div class="row g-3 mb-3">
            ...
            <div class="card overflow-hidden" style="min-width: 12rem">
              <div class="bg-holder bg-card" style="background-image:url(../f_assets/assets/img/icons/spot-illustrations/corner-1.png);"></div>
              <!--/.bg-holder-->
              <div class="card-body position-relative">
                <h6>Ongoing Loan<span class="badge badge-soft-warning rounded-pill ms-2">-0.23%</span></h6>
          ...
          <div class="col-sm-6">
            <div class="card overflow-hidden" style="min-width: 12rem">
              <div class="bg-holder bg-card" style="background-image:url(../f_assets/assets/img/icons/spot-illustrations/corner-2.png);"></div>
              <!--/.bg-holder-->
              <div class="card-body position-relative">
                <h6>Past Loan<span class="badge badge-soft-info rounded-pill ms-2">0.0%</span></h6>
